...
OBJS_KERNEL= $(addprefix $(BUILD)/, kernel.o asm.o exception.o debug.o kinout.o kerror.o kpcb.o kprocess.o kprocess_list.o kprogram.o kscheduler.o syscall.o ksyscall.o kexception.o uart.o splash.o ksleep.o )
OBJS_USER= $(addprefix $(BUILD)/, string.o process.o increment.o stdio.o error.o coquille.o inf.o)
